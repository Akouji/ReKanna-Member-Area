...
<?php include('../header.php') ?>
    ...
    <main role="main" class="container">
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <form action="inc/member_edit.php" method="post">
        <b>Edit member: <?php echo $data['nama']; ?></b><br/>
	...
	<div class="form-group">
            <label>Level:</label>
            <input type="number" name="level" class="form-control" value="<?php echo $data['level']; ?>" />
        </div>
	<div class="form-group">
            <label>Code:</label>
